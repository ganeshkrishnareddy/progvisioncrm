        ...
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background-color: #f8fafc; padding: 15px; border-radius: 8px; margin: 20px 0; border: 1px solid #e2e8f0;">
            ...
            <ul style="list-style: none; padding: 0;">
              <li><strong>Portal Link:</strong> <a href="https://progvision.space/login">https://progvision.space/login</a></li>
          ...
          <p style="margin: 0; font-size: 0.9em; color: #64748b;">support@progvision.online | <a href="https://progvision.space">www.progvision.space</a></p>
        </div>
      `,
    });
